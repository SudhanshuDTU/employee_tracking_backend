...
export const createUser = async (user) => {
  const query =
    'INSERT INTO "team" (id,name, email, role) VALUES ($1, $2, $3, $4) RETURNING *';
...
export const updateUser = async (id, user) => {
  try {
    const query =
      'UPDATE "team" SET name = $1, email = $2, role = $3, shiftids = $4 WHERE id = $5 RETURNING *';
...
export const updateOdometerVisible = async (id,odometer_visible) => {
  try {
    const query =
      'UPDATE "team" SET odometer_visible = $1 WHERE id = $2 RETURNING *';
